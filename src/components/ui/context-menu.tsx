...
import { popoverItemFocusStyles } from "./popover-item-styles";
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "group/context-menu-item relative flex cursor-default items-center gap-2.5 rounded-xl px-3 py-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-9.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        popoverItemFocusStyles,
...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center rounded-xl px-3 py-2 text-sm outline-hidden select-none data-inset:pl-9.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        popoverItemFocusStyles,
        className,
      )}
      {...props}
...
function ContextMenuCheckboxItem({
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-xl py-2 pr-8 pl-3 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-9.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        popoverItemFocusStyles,
        className,
      )}
      checked={checked}
...
function ContextMenuRadioItem({
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-9.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        popoverItemFocusStyles,
        className,
      )}
      {...props}
...
function ContextMenuShortcut({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground group-focus/context-menu-item:text-popover-foreground ml-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
